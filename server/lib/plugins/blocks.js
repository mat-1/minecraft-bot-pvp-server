...
module.exports.player = function (player, serv) {
	...
	player.setBlock = (position, stateId) => {
		console.log('setting block at', position, stateId)
		serv.setBlock(player.world, position, stateId)
	}
...
module.exports.server = function (serv, { version }) {
	...
	serv.commands.add({
		...
		action (params, ctx) {
			...
			else serv.setBlock(serv.hub, new Vec3(res[0], res[1], res[2]).floored(), stateId)
		}
	})
	...
	serv.commands.add({
		...
		action (params, ctx) {
			...
			else serv.setBlockAction(serv.hub, new Vec3(params[1], params[2], params[3]).floored(), params[4], params[5])
		}
	})
}
