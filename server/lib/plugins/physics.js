...
module.exports.entity = function (entity, serv, { version }) {
  ...
  entity.calculatePhysics = async (delta) => {
    ...
    // serv.emitParticle(30, serv.hub, entity.position, { size: new Vec3(0, 0, 0) });
  ...
  entity.sendVelocity = (vel, maxVel) => {
    ...
    // minecraft gets mad if the velocity is too high, lol
    scaledVelocity = scaledVelocity.max(new Vec3(-32768, -32768, -32768)).min(new Vec3(32767, 32767, 32767))
